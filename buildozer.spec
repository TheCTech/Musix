...
source.exclude_dirs = .venv, __pycache__, .vscode
...
requirements = python3,kivy,python-dotenv,requests,spotipy,urllib3,charset-normalizer,colorama,colorlog,docutils,RapidFuzz,Pygments,filetype
